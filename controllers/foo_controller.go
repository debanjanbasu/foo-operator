...
import (
	...
	tutorialv1 "foo.op/fooop/api/v1"
)
...
//+kubebuilder:rbac:groups=tutorial.foo.op,resources=foos,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tutorial.foo.op,resources=foos/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tutorial.foo.op,resources=foos/finalizers,verbs=update
